...
const ServicesPage = () => (
		<div>
				<Helmet
						title="Services | Dream Akasa | We help companies from design to development with solution-by-design and human-centered approach."
						meta={[
						{
								name: 'description',
								content: 'Dream Akasa'
								...
								<div className="service col-sm-12">
										<div className="items media">
												...
												<div className="media-body">
														...
														<p className="item__sub-text">Smartphone is handy device that able to carry
																around. We build and develop mobile application so it can be accessed anytime
																and anywhere for you</p>
												</div>
										</div>
								</div>
								<div className="service col-sm-12">
										<div className="items media">
												...
												<div className="media-body">
														...
														<p className="item__sub-text">We make solution of the problem as the product and
																we design it so our product will be helpful and also.. beautiful!</p>
												</div>
										</div>
								</div>
								<div className="service col-sm-12">
										<div className="items media">
												...
												<div className="media-body">
														...
														<p className="item__sub-text">Sharing is caring. By sharing experiences and
																knowledge, we helped educate about developing the great products.</p>
												</div>
										</div>
								</div>
						</div>
				...
				<div className="row section section--quotes text-center border-b-grey">
						<div className="container">
								...
								<div
										...
										className="carousel carousel--text slide col-sm-12"
										data-ride="carousel">
										{/* <!-- Indicators --> */}
										...
										<div className="carousel-inner" role="listbox">
												...
												<div className="item">
														<div className="carousel-caption">
																<blockquote>Dream akasa help us doing usability test for our
																		<i>stealth</i>
