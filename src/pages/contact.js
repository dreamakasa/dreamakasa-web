				...
				<div className="row section section--banner text-center transparent">
						<div className="container">
								<div className="col-md-10 col-md-offset-1">
										...
										<h6 className="text">
												We're available for all work related inquiries and general questioning. Reach
												out to us anytime and we'll get back to you!
										</h6>
								</div>
						</div>
				</div>
				<div className="row section section--contact transparent p-t-0">
						<div className="container">
								<form className="col-sm-6 col-sm-offset-3 form--panel">
										...
										<button
												type="submit"
												className="btn btn-default btn-block btn--orange animate--arrow-right hover--swipe-left">
												SUBMIT
