    ...
    <div className="row section section--banner transparent text-center">
      <div className="container">
        <div className="col-md-10 col-md-offset-1">
          ...
          <h6 className="text">
            We are team that solve problems by design. We solve problems and develop
            products using methods UX Driven Development, which is developing a product that
            adopts what is required by the user so that the product offered is more
            appropriate and well targeted. Our team have extraordinary members and also
      ...
      <div className="container">
        ...
        <div className=" col-sm-12 m-t-1">
          ...
          <div className="col-sm-6 col-md-3 text-center m-b-2 items">
            ...
            <p className="item__sub-text">From research, we design and develop the solution,
              including the information structure, workflow, and application.
            </p>
          </div>
          <div className="col-sm-6 col-md-3 text-center m-b-2 items">
            <div className="item__img-wrapper circle">
            ...
            <p className="item__sub-text">Users evaluate the design solution and use the
              findings to iterate continuosly to optimize our design solutions.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="row section section--team-join text-center border-b-grey">
      <div className="container">
        ...
        <h6 className="text m-b-2 col-sm-12 text-left">
          Do you like teaching or learning or both ? Want to have more experience? Let’s
          join us! Let us know about you by
